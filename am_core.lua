...
am_macro = { mt = { __index = CreateFrame("Frame") } }
...
am_modifier = { mt = { __index = CreateFrame("Frame") } }
...
am_condition = { mt = { __index = CreateFrame("Frame") } }
...
function am_container.mt.__index:fixbgs()
